...
<!-- * Edit the make-xsl-params.xsl file instead. -->
   ...
   <xslt:variable name="xsl-wordml-parameters-list">
      <simplelist role="param">
         <member>pages.template</member>
         <member>wordml.template</member>
      </simplelist>
   </xslt:variable>
   <xslt:variable name="xsl-wordml-parameters" select="exsl:node-set($xsl-wordml-parameters-list)/simplelist"/>
   ...
   <xslt:template name="is-wordml-parameter">
      <xslt:param name="param" select="''"/>
      <xslt:choose>
         <xslt:when test="$xsl-wordml-parameters/member[. = $param]">1</xslt:when>
         <xslt:otherwise>0</xslt:otherwise>
      </xslt:choose>
   </xslt:template>
</xslt:stylesheet>